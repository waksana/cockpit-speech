...
Cancellation discards audio rather than retaining it for retry and stops future
text updates; already-written draft text is preserved, not automatically undone. Capture loss,
...
Speech 0.3.1 and later require Cockpit 0.2.6's additive public UI classes. It uses the
...
host selectors or separately exported font variables. No host API change is needed.
...
`66ed90de045be307b2675ad3b5f6e746f88a931f` (`@cockpit/module-api` 0.2.6).
