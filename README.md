...
Speech 0.9.1 requires the paired host's `draftLifecycleVersion: 1` and
...
node scripts/package.mjs module-output-0.9.1
node scripts/verify-package.mjs module-output-0.9.1/cockpit-speech-0.9.1.tgz
```
